...
/* 	name		type*/
RSF(NONE,		)
RSF(SHRIEK,		RST_ANNOY)
RSF(ARROW_1,	RST_BOLT)
RSF(ARROW_2,	RST_BOLT)
RSF(ARROW_3,	RST_BOLT)
RSF(ARROW_4,	RST_BOLT)
RSF(BR_ACID,	RST_BREATH)
RSF(BR_ELEC,	RST_BREATH)
RSF(BR_FIRE,	RST_BREATH)
RSF(BR_COLD,	RST_BREATH)
RSF(BR_POIS,	RST_BREATH)
RSF(BR_NETH,	RST_BREATH)
RSF(BR_LIGHT,	RST_BREATH)
RSF(BR_DARK,	RST_BREATH)
RSF(BR_SOUN,	RST_BREATH)
RSF(BR_CHAO,	RST_BREATH)
RSF(BR_DISE,	RST_BREATH)
RSF(BR_NEXU,	RST_BREATH)
RSF(BR_TIME,	RST_BREATH)
RSF(BR_INER,	RST_BREATH)
RSF(BR_GRAV,	RST_BREATH)
RSF(BR_SHAR,	RST_BREATH)
RSF(BR_PLAS,	RST_BREATH)
RSF(BR_WALL,	RST_BREATH)
RSF(BR_MANA,	RST_BREATH)
RSF(BOULDER,	RST_BOLT)
