...
RSF(ARROW_1,	RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(ARROW_2,	RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(ARROW_3,	RST_BOLT | RST_INNATE | RST_ARCHERY)
RSF(ARROW_4,	RST_BOLT | RST_INNATE | RST_ARCHERY)
...
RSF(CAUSE_1,	RST_DIRECT)
RSF(CAUSE_2,	RST_DIRECT)
RSF(CAUSE_3,	RST_DIRECT)
RSF(CAUSE_4,	RST_DIRECT)
