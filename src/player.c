...
static void adjust_level(struct player *p, bool verbose)
{
	                       ...
	                       p->expfact / 100L)))
	{
		...
		effect_simple(EF_RESTORE_STAT, "0", STAT_STR, 1, 0);
		effect_simple(EF_RESTORE_STAT, "0", STAT_INT, 1, 0);
		effect_simple(EF_RESTORE_STAT, "0", STAT_WIS, 1, 0);
		effect_simple(EF_RESTORE_STAT, "0", STAT_DEX, 1, 0);
		effect_simple(EF_RESTORE_STAT, "0", STAT_CON, 1, 0);
	}
