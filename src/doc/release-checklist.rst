...
* Check it compiles on:
   ...
   * Mac OS X Cocoa
      ...
      * backwardsEric can manually check on what he has available.  Currently
         that is macOS 12.7.6 + Xcode 14.2 on Intel and macOS 15.7.2 +
         Xcode 16.4 on Apple silicon.
...
* Update docs:
   ...
   * check copyrights and licences are correct and up-to-date
      ...
      * The SDL and SDL2 front ends do not display a copyright in their
        About dialogs.  The Windows front end does not have an About dialog.
