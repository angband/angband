...
SPELL(PRAYER_RECHARGING,			FALSE,	NULL,		V(RECHARGING),				F(RECHARGING))
SPELL(PRAYER_DISPEL_CURSE,			FALSE,	NULL,		NULL,						F(DISPEL_CURSE))
SPELL(PRAYER_ENCHANT_WEAPON,		FALSE,	NULL,		V(ENCHANT_WEAPON),			F(ENCHANT_WEAPON))
SPELL(PRAYER_ENCHANT_ARMOUR,		FALSE,	NULL,		V(ENCHANT_ARMOUR),			F(ENCHANT_ARMOUR))
