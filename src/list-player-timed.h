...
TMD(SLOW,		"You feel yourself moving slower!",			"You feel yourself speed up.",					NULL,										NULL,										0,									PU_BONUS,										MSG_SLOW,		TMD_FAIL_FLAG_OBJECT,	OF_FREE_ACT)
TMD(BLIND,		"You are blind.",							"You blink and your eyes clear.",				NULL,										NULL,										PR_MAP,								PU_FORGET_VIEW | PU_UPDATE_VIEW | PU_MONSTERS,	MSG_BLIND,		TMD_FAIL_FLAG_OBJECT,	OF_PROT_BLIND ) 
TMD(PARALYZED,	"You are paralysed!",						"You can move again.",							NULL,										NULL,										0,									0,												MSG_PARALYZED,	TMD_FAIL_FLAG_OBJECT,	OF_FREE_ACT)
TMD(CONFUSED,	"You are confused!",						"You are no longer confused.",					"You are more confused!",					"You feel a little less confused.",			0,									0,												MSG_CONFUSED,	TMD_FAIL_FLAG_OBJECT,	OF_PROT_CONF)
TMD(AFRAID,		"You are terrified!",						"You feel bolder now.",							"You are more scared!",						"You feel a little less scared.",			0,									PU_BONUS,										MSG_AFRAID,		TMD_FAIL_FLAG_OBJECT,	OF_PROT_FEAR)
TMD(IMAGE,		"You feel drugged!",						"You can see clearly again.",					"You feel more drugged!",					"You feel less drugged.",					PR_MAP | PR_MONLIST | PR_ITEMLIST,	0,												MSG_DRUGGED,	TMD_FAIL_FLAG_RESIST,	ELEM_CHAOS)
TMD(POISONED,	"You are poisoned!",						"You are no longer poisoned.",					"You are more poisoned!",					"You are less poisoned.",					0,									0,												MSG_POISONED,	TMD_FAIL_FLAG_RESIST,	ELEM_POIS)
TMD(CUT,		NULL,										NULL,											NULL,										NULL,										0,									0,												0,				0,	0)
TMD(STUN,		NULL,										NULL,											NULL,										NULL,										0,									0,												0,				TMD_FAIL_FLAG_OBJECT,	OF_PROT_STUN)
...
TMD(OPP_ACID,	"You feel resistant to acid!",				"You are no longer resistant to acid.",			"You feel more resistant to acid!",			"You feel less resistant to acid.",			PR_STATUS,							0,												MSG_RES_ACID,	TMD_FAIL_FLAG_VULN,	ELEM_ACID)
TMD(OPP_ELEC,	"You feel resistant to electricity!",		"You are no longer resistant to electricity.",	"You feel more resistant to electricity!",	"You feel less resistant to electricity.",	PR_STATUS,							0,												MSG_RES_ELEC,	TMD_FAIL_FLAG_VULN,	ELEM_ELEC)
TMD(OPP_FIRE,	"You feel resistant to fire!",				"You are no longer resistant to fire.",			"You feel more resistant to fire!",			"You feel less resistant to fire.",			PR_STATUS,							0,												MSG_RES_FIRE,	TMD_FAIL_FLAG_VULN,	ELEM_FIRE)
TMD(OPP_COLD,	"You feel resistant to cold!",				"You are no longer resistant to cold.",			"You feel more resistant to cold!",			"You feel less resistant to cold.",			PR_STATUS,							0,												MSG_RES_COLD,	TMD_FAIL_FLAG_VULN,	ELEM_COLD)
