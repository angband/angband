...
RSE(51,	RSF_TPORT,		0,			FALSE,	S_TELE_SELF,	RV((MAX_SIGHT * 2 + 5),0,0,0), RV(0,0,0,0), 0, FALSE, 0,		RV(15,0,0,0))
...
RSE(55, RSF_SHRIEK,		0,			TRUE,	S_AGGRAVATE,	RV(0,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,150,1))
RSE(56,	RSF_S_KIN,		0,			FALSE,	S_KIN,			RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,200,1))
...
RSE(59,	RSF_S_ANIMAL,	0,			FALSE,	S_ANIMAL,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(30,0,0,0))
RSE(60,	RSF_S_SPIDER,	0,			FALSE,	S_SPIDER,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(20,0,0,0))
RSE(61,	RSF_S_HOUND,	0,			FALSE,	S_HOUND,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(100,0,0,0))
RSE(62,	RSF_S_HYDRA,	0,			FALSE,	S_HYDRA,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(150,0,0,0))
RSE(63,	RSF_S_ANGEL,	0,			FALSE,	S_ANGEL,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(150,0,0,0))
