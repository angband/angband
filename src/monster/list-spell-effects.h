...
RSE(5,	0,				GF_SHARD,	TRUE,	TMD_CUT,		RV(0,0,0,0),	RV(0,0,100,0),	0,		FALSE,	0,				RV(5,125,0,0))
...
RSE(47,	RSF_BLINK,		0,			FALSE,	S_BLINK,		RV(10,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(15,0,0,0))
...
RSE(51,	RSF_DARKNESS,	0,			FALSE,	S_DARKEN,		RV(3,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(5,0,0,0))
RSE(52,	RSF_TRAPS,		0,			FALSE,	S_TRAPS,		RV(0,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(10,0,0,0))
RSE(53,	RSF_FORGET,		0,			TRUE,	TMD_AMNESIA,	RV(3,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(25,0,0,0))
RSE(54, RSF_SHRIEK,		0,			TRUE,	S_AGGRAVATE,	RV(0,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,150,1))
RSE(55,	RSF_S_KIN,		0,			FALSE,	S_KIN,			RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,200,1))
RSE(56,	RSF_S_MONSTER,	0,			FALSE,	S_MONSTER,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(40,0,0,0))
RSE(57,	RSF_S_MONSTERS,	0,			FALSE,	S_MONSTERS,		RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(80,0,0,0))
RSE(58,	RSF_S_ANIMAL,	0,			FALSE,	S_ANIMAL,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(30,0,0,0))
RSE(59,	RSF_S_SPIDER,	0,			FALSE,	S_SPIDER,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(20,0,0,0))
RSE(60,	RSF_S_HOUND,	0,			FALSE,	S_HOUND,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(100,0,0,0))
RSE(61,	RSF_S_HYDRA,	0,			FALSE,	S_HYDRA,		RV(6,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(150,0,0,0))
RSE(62,	RSF_S_ANGEL,	0,			FALSE,	S_ANGEL,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(150,0,0,0))
RSE(63,	RSF_S_DEMON,	0,			FALSE,	S_DEMON,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,150,1))
RSE(64,	RSF_S_UNDEAD,	0,			FALSE,	S_UNDEAD,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,150,1))
RSE(65,	RSF_S_DRAGON,	0,			FALSE,	S_DRAGON,		RV(1,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(0,0,150,1))
RSE(66,	RSF_S_HI_DEMON,	0,			FALSE,	S_HI_DEMON,		RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(250,0,0,0))
RSE(67,	RSF_S_HI_UNDEAD,0,			FALSE,	S_HI_UNDEAD,	RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(400,0,0,0))
RSE(68,	RSF_S_HI_DRAGON,0,			FALSE,	S_HI_DRAGON,	RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(400,0,0,0))
RSE(69,	RSF_S_WRAITH,	0,			FALSE,	S_WRAITH,		RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(450,0,0,0))
RSE(70,	RSF_S_UNIQUE,	0,			FALSE,	S_UNIQUE,		RV(8,0,0,0),	RV(0,0,0,0),	0,		FALSE,	0,				RV(500,0,0,0))
