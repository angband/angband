...
RSF(TELE_TO,    RST_ANNOY,	"come hither",		0,	0,	0,			MSG_TELEPORT,	FALSE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(TELE_AWAY,  RST_ESCAPE,	"go away",			0,	0,	0,			MSG_TELEPORT,	FALSE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(TELE_LEVEL, RST_ESCAPE,	"go far away",		0,	0,	0,			MSG_TPLEVEL,	TRUE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
...
RSF(S_ANGEL,    RST_SUMMON,	"angels",			0,	0,	0,			MSG_SUM_ANGEL,	FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_DEMON,    RST_SUMMON,	"demons",			0,	0,	0,			MSG_SUM_DEMON,	FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_UNDEAD,   RST_SUMMON,	"the undead",		0,	0,	0,			MSG_SUM_UNDEAD,	FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_DRAGON,   RST_SUMMON,	"dragons",			0,	0,	0,			MSG_SUM_DRAGON,	FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
