...
ELEM(WATER,		"water",			"",					"water",			0,	RV(0,0,0,0),	6,		0,		0,				COLOUR_SLATE)
ELEM(ICE,		"ice",				"",					"something sharp",	1,  RV(3,0,0,0),	6,		0,		0,				COLOUR_WHITE)
...
ELEM(METEOR,	"a meteor",			"",					"something",		0,	RV(0,0,0,0),	6,		0,		0,				COLOUR_RED)
ELEM(MISSILE,	"a missile",		"",					"something",		0,	RV(0,0,0,0),	6,		0,		0,				COLOUR_VIOLET)
ELEM(MANA,		"mana",				"the elements",		"something",		0,	RV(0,0,0,0),	3,		1600,	MSG_BR_ELEMENTS,COLOUR_L_DARK)
ELEM(HOLY_ORB,	"a holy orb",		"",					"something",		0,	RV(0,0,0,0),	6,		0,		0,				COLOUR_L_DARK)
ELEM(ARROW,		"an arrow",			"",					"something sharp",	0,	RV(0,0,0,0),	6,		0,		0,				COLOUR_WHITE)
