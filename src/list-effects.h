...
EFFECT(CURE_LIGHT,     FALSE,  5,	"heals 20 hitpoints, some cut damage, makes you a little less confused, and cures blindness")
EFFECT(CURE_SERIOUS,   FALSE,  8,	"heals 40 hitpoints, cut damage, and cures blindness and confusion")
EFFECT(CURE_CRITICAL,  FALSE, 10,	"heals 60 hitpoints, cut damage, and cures stunning, poisoning, blindness, and confusion")
