...
EFFECT(STAR,						FALSE,	"dam",		2,		EFINFO_BOLTD,	"fires a %s line in all directions, each dealing %s damage")
...
EFFECT(BOLT,						TRUE,	"dam",		2,		EFINFO_BOLTD,	"casts a %s bolt dealing %s damage")
EFFECT(BEAM,						TRUE,	"dam",		2,		EFINFO_BOLTD,	"casts a %s beam dealing %s damage")
EFFECT(BOLT_OR_BEAM,				TRUE,	"dam",		2,		EFINFO_BOLTD,	"casts a %s bolt or beam dealing %s damage")
EFFECT(LINE,						TRUE,	"dam",		2,		EFINFO_BOLTD,	"creates a %s line dealing %s damage")
