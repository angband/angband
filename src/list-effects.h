...
EFFECT(CURE_NONORLYBIG,FALSE, 24,	"restores 5000 hit points, restores experience and stats, heals cut damage, and cures stunning, poison, blindness, and confusion")
...
EFFECT(LOSKILL,        FALSE, 24,	"removes all non-unique monsters within 20 squares, dealing you damage in the process")
