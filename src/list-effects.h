...
EFFECT(CURE_LIGHT,     FALSE,  6,	"heals you a small amount (15% of your wounds, minimum 15HP), heals some cut damage, makes you a little less confused, and cures blindness")
EFFECT(CURE_SERIOUS,   FALSE, 10,	"heals you a fair amount (1/5 of your wounds, minimum 25HP), heals cut damage, and cures blindness and confusion")
EFFECT(CURE_CRITICAL,  FALSE, 12,	"heals you a large amount (1/4 of your wounds, minimum 30HP), heals cut damage, and cures stunning, poisoning, blindness, and confusion")
EFFECT(CURE_FULL,      FALSE, 14,	"heals you a really large amount (35% of max HP, minimum 300HP), heals cut damage, and cures stunning, poisoning, blindness, and confusion")
EFFECT(CURE_FULL2,     FALSE, 20,	"restores 1200 hit points, heals cut damage, and cures stunning, poisoning, blindness, and confusion")
EFFECT(CURE_NONORLYBIG,FALSE, 25,	"restores 5000 hit points, restores experience and stats, heals cut damage, and cures stunning, poison, blindness, and confusion")
EFFECT(CURE_TEMP,      FALSE,  9,	"heals cut damage, and cures all stunning, poison, blindness and confusion")
EFFECT(HEAL1,          FALSE, 15,	"heals 500 hit points")
EFFECT(HEAL2,          FALSE, 18,	"heals 1000 hit points")
EFFECT(HEAL3,          FALSE, 16,	"heals 500 hit points, heals cut damage, and cures stunning")
...
EFFECT(RESTORE_ST_LEV, FALSE, 18,	"restores all your stats and your experience points")

EFFECT(TMD_INFRA,      FALSE,  6,	"extends your infravision by 50 feet for 4d25+100 turns")
EFFECT(TMD_SINVIS,     FALSE,  8,	"cures blindness and allows you to see invisible things for 2d6+12 turns")
EFFECT(TMD_ESP,        FALSE, 10,	"cures blindness and gives you telepathy for 6d6+12 turns")

EFFECT(ENLIGHTENMENT,  FALSE, 25,	"completely lights up and magically maps the level")
...
EFFECT(HERO,           FALSE,  8,	"restores 10 hit points, removes fear and grants you resistance to fear and +12 to-hit for 1d25+25 turns")
EFFECT(SHERO,          FALSE, 10,	"restores 30 hit points, removes fear and grants you resistance to fear, +24 to-hit, and -10AC for 1d25+25 turns")

EFFECT(RESIST_ACID,    FALSE,  5,	"grants temporary resistance to acid for 1d10+10 turns")
EFFECT(RESIST_ELEC,    FALSE,  5,	"grants temporary resistance to electricity for 1d10+10 turns")
EFFECT(RESIST_FIRE,    FALSE,  5,	"grants temporary resistance to fire for 1d10+10 turns")
EFFECT(RESIST_COLD,    FALSE,  5,	"grants temporary resistance to cold for 1d10+10 turns")
EFFECT(RESIST_POIS,    FALSE,  5,	"grants temporary resistance to poison for 1d10+10 turns")
EFFECT(RESIST_ALL,     FALSE, 11,	"grants temporary resistance to acid, electricity, fire, cold and poison for 1d20+20 turns")

EFFECT(DETECT_TREASURE,   FALSE,  7,	"detects gold and objects nearby")
EFFECT(DETECT_TRAP,       FALSE,  7,	"detects traps nearby")
EFFECT(DETECT_DOORSTAIR,  FALSE,  7,	"detects doors and stairs nearby")
EFFECT(DETECT_INVIS,      FALSE,  7,	"detects invisible creatures nearby")
EFFECT(DETECT_EVIL,       FALSE,  7,	"detects evil creatures nearby")
EFFECT(DETECT_ALL,        FALSE, 11,	"detects treasure, traps, doors, stairs, and all creatures nearby")

EFFECT(ENCHANT_TOHIT,  FALSE, 15,	"attempts to magically enhance a weapon's to-hit bonus")
EFFECT(ENCHANT_TODAM,  FALSE, 18,	"attempts to magically enhance a weapon's to-dam bonus")
EFFECT(ENCHANT_WEAPON, FALSE, 20,	"attempts to magically enhance a weapon both to-hit and to-dam")
...
EFFECT(DEEP_DESCENT,   FALSE, 20,	"transports you two or three levels below your maximum dungeon depth")
...
EFFECT(LOSSLOW,        FALSE,  8,	"slows all non-unique monsters within line of sight")
EFFECT(LOSSLEEP,       FALSE,  9,	"sleeps all non-unique creatures within line of sight")
EFFECT(LOSCONF,        FALSE, 10,	"confuses all non-unique creatures within line of sight")
EFFECT(LOSKILL,        FALSE, 26,	"removes all non-unique monsters within 20 squares, dealing you damage in the process")
EFFECT(ILLUMINATION,   FALSE,  4,	"lights up the surrounding area, hurting light-sensitive creatures")
EFFECT(CLAIRVOYANCE,   FALSE, 25,	"maps the entire level and detects objects, traps, doors, and stairs")
...
EFFECT(SLEEPII,        FALSE,  9,	"puts to sleep the monsters around you")
...
EFFECT(DRAIN_LIFE1,    TRUE,  10,	"drains up to 90 hit points of life from a target creature")
EFFECT(DRAIN_LIFE2,    TRUE,  11,	"drains up to 120 hit points of life from a target creature")
EFFECT(DRAIN_LIFE3,    TRUE,  12,	"drains up to 150 hit points of life from a target creature")
EFFECT(DRAIN_LIFE4,    TRUE,  13,	"drains up to 250 hit points of life from a target creature")
EFFECT(MISSILE,        TRUE,   3,	"fires a magic missile with damage 3d4")
EFFECT(MANA_BOLT,      TRUE,   8,	"fires a mana bolt with damage 12d8")
EFFECT(BIZARRE,        TRUE,  20,	"does bizarre things")
EFFECT(ARROW,          TRUE,  12,	"fires a magical arrow with damage 150")
EFFECT(STINKING_CLOUD, TRUE,   3,	"fires a stinking cloud with damage 12")
EFFECT(STONE_TO_MUD,   TRUE,   9,	"turns rock into mud")
...
EFFECT(STARLIGHT,      FALSE,  7,	"fires a line of light in all directions, each one causing light-sensitive creatures 6d8 damage")
EFFECT(STARLIGHT2,     FALSE,  8,	"fires a line of light in all directions, each one causing 10d8 damage")
EFFECT(BERSERKER,      FALSE, 11,	"puts you in a berserker rage for d50+50 turns")
...
EFFECT(DRAGON_BLUE,    TRUE,   10,	"allows you to breathe lightning for 100 damage")
EFFECT(DRAGON_GREEN,   TRUE,   12,	"allows you to breathe poison gas for 150 damage")
EFFECT(DRAGON_RED,     TRUE,   13,	"allows you to breathe fire for 200 damage")
EFFECT(DRAGON_MULTIHUED, TRUE, 14,	"allows you to breathe the elements for 250 damage")
EFFECT(DRAGON_BRONZE,  TRUE,   11,	"allows you to breathe confusion for 120 damage")
EFFECT(DRAGON_GOLD,    TRUE,   12,	"allows you to breathe sound for 130 damage")
EFFECT(DRAGON_CHAOS,   TRUE,   13,	"allows you to breathe chaos or disenchantment for 220 damage")
EFFECT(DRAGON_LAW,     TRUE,   13,	"allows you to breathe sound/shards for 230 damage")
EFFECT(DRAGON_BALANCE, TRUE,   14,	"allows you to breathe balance for 250 damage")
EFFECT(DRAGON_SHINING, TRUE,   12,	"allows you to breathe light or darkness for 200 damage")
EFFECT(DRAGON_POWER,   TRUE,   15,	"allows you to breathe for 300 damage")
