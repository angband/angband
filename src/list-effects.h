...
EFFECT(HEAL_HP,						FALSE,	"heal",		0,		EFINFO_NONE,	"heals some hitpoints")
EFFECT(MON_HEAL_HP,					FALSE,	NULL,		0,		EFINFO_NONE,	"heals some monster hitpoints")
EFFECT(NOURISH,						FALSE,	NULL,		0,		EFINFO_NONE,	"feeds you")
EFFECT(CRUNCH,						FALSE,	NULL,		0,		EFINFO_NONE,	"crunches")
EFFECT(CURE,						FALSE,	NULL,		0,		EFINFO_NONE,	"cures status")
EFFECT(TIMED_SET,					FALSE,	NULL,		0,		EFINFO_NONE,	"sets status")
EFFECT(TIMED_INC,					FALSE,	"dur",		0,		EFINFO_NONE,	"increases status")
EFFECT(MON_TIMED_INC,				FALSE,	NULL,		0,		EFINFO_NONE,	"increases monster status")
EFFECT(TIMED_DEC,					FALSE,	NULL,		0,		EFINFO_NONE,	"cures some status")
EFFECT(SET_NOURISH,					FALSE,	NULL,		0,		EFINFO_NONE,	"sets your stomach contents")
...
EFFECT(RESTORE_STAT,				FALSE,	NULL,		0,		EFINFO_NONE,	"restores a stat")
EFFECT(DRAIN_STAT,					FALSE,	NULL,		0,		EFINFO_NONE,	"reduces a stat with damage")
EFFECT(LOSE_RANDOM_STAT,			FALSE,	NULL,		0,		EFINFO_NONE,	"reduces a stat")
EFFECT(GAIN_STAT,					FALSE,	NULL,		0,		EFINFO_NONE,	"increases a stat")
EFFECT(RESTORE_EXP,					FALSE,	NULL,		0,		EFINFO_NONE,	"restores your experience")
EFFECT(GAIN_EXP,					FALSE,	NULL,		0,		EFINFO_NONE,	"increases your experience")
...
EFFECT(PROJECT_LOS,					FALSE,	"dam",		0,		EFINFO_NONE,	"affects all monsters in line of sight")
...
EFFECT(SUMMON,						FALSE,	NULL,		0,		EFINFO_NONE,	"summons monsters at the current dungeon level")
...
EFFECT(TELEPORT,					FALSE,	"range",	0,		EFINFO_NONE,	"teleports you randomly")
...
EFFECT(DESTRUCTION,					FALSE,	NULL,		0,		EFINFO_NONE,	"destroys an area around you in the shape of a circle radius 15, and blinds you for 1d10+10 turns")
EFFECT(EARTHQUAKE,					FALSE,	NULL,		0,		EFINFO_NONE,	"causes an earthquake around you")
EFFECT(ENLIGHTENMENT,				FALSE,	NULL,		0,		EFINFO_NONE,	"completely lights up and magically maps the level")
EFFECT(LIGHT_AREA,					FALSE,	NULL,		0,		EFINFO_NONE,	"lights up the surrounding area, hurting light-sensitive creatures")
EFFECT(DARKEN_AREA,					FALSE,	NULL,		0,		EFINFO_NONE,	"darkens the surrounding area")
EFFECT(BALL,						TRUE,	"dam",		0,		EFINFO_NONE,	"fires a ball")
EFFECT(BREATH,						TRUE,	NULL,		0,		EFINFO_NONE,	"fires a ball")
EFFECT(SWARM,						TRUE,	"dam",		0,		EFINFO_NONE,	"fires a series of balls")
EFFECT(STAR,						FALSE,	"dam",		0,		EFINFO_NONE,	"fires a line in all directions")
EFFECT(STAR_BALL,					FALSE,	"dam",		0,		EFINFO_NONE,	"fires balls in all directions")
EFFECT(BOLT,						TRUE,	"dam",		0,		EFINFO_NONE,	"creates a bolt")
EFFECT(BEAM,						TRUE,	"dam",		0,		EFINFO_NONE,	"creates a beam")
EFFECT(BOLT_OR_BEAM,				TRUE,	"dam",		0,		EFINFO_NONE,	"creates a bolt or beam")
EFFECT(LINE,						TRUE,	"dam",		0,		EFINFO_NONE,	"creates a line")
EFFECT(ALTER,						TRUE,	NULL,		0,		EFINFO_NONE,	"creates a line which may affect terrain and/or items")
EFFECT(BOLT_AWARE,					TRUE,	"dam",		0,		EFINFO_NONE,	"creates a bolt")
EFFECT(TOUCH,						FALSE,	NULL,		0,		EFINFO_NONE,	"affects all adjacent squares")
EFFECT(TOUCH_AWARE,					FALSE,	NULL,		0,		EFINFO_NONE,	"affects all adjacent squares")
