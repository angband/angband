...
EFFECT(HEAL_HP,						FALSE,	"heal",		2,		EFINFO_NONE,	"heals %d hitpoints%s")
EFFECT(MON_HEAL_HP,					FALSE,	NULL,		1,		EFINFO_NONE,	"heals %s monster hitpoints")
EFFECT(NOURISH,						FALSE,	NULL,		1,		EFINFO_NONE,	"feeds you for %d turns")
EFFECT(CRUNCH,						FALSE,	NULL,		0,		EFINFO_NONE,	"crunches")
EFFECT(CURE,						FALSE,	NULL,		1,		EFINFO_NONE,	"cures %s")
EFFECT(TIMED_SET,					FALSE,	NULL,		2,		EFINFO_NONE,	"renders you %s for %d turns")
EFFECT(TIMED_INC,					FALSE,	"dur",		2,		EFINFO_NONE,	"extends %s for %d turns")
EFFECT(MON_TIMED_INC,				FALSE,	NULL,		2,		EFINFO_NONE,	"increases monster %s by %d turns")
EFFECT(TIMED_DEC,					FALSE,	NULL,		2,		EFINFO_NONE,	"reduces length of %s by %d turns")
EFFECT(SET_NOURISH,					FALSE,	NULL,		1,		EFINFO_NONE,	"leaves you nourished for %d turns")
...
EFFECT(RESTORE_STAT,				FALSE,	NULL,		1,		EFINFO_NONE,	"restores your %s")
EFFECT(DRAIN_STAT,					FALSE,	NULL,		2,		EFINFO_NONE,	"reduces your %s with damage %s")
EFFECT(LOSE_RANDOM_STAT,			FALSE,	NULL,		1,		EFINFO_NONE,	"reduces a stat other than %s")
EFFECT(GAIN_STAT,					FALSE,	NULL,		1,		EFINFO_NONE,	"increases your %s")
...
EFFECT(PROJECT_LOS,					FALSE,	"dam",		2,		EFINFO_NONE,	"damages all %s in line of sight by %s hitpoints")
...
EFFECT(SUMMON,						FALSE,	NULL,		1,		EFINFO_NONE,	"summons %s at the current dungeon level")
...
EFFECT(TELEPORT,					FALSE,	"range",	2,		EFINFO_NONE,	"teleports %s randomly %s grids")
...
EFFECT(DESTRUCTION,					FALSE,	NULL,		1,		EFINFO_NONE,	"destroys an area around you in the shape of a circle radius %d, and blinds you for 1d10+10 turns")
EFFECT(EARTHQUAKE,					FALSE,	NULL,		1,		EFINFO_NONE,	"causes an earthquake around you of radius %d")
EFFECT(ENLIGHTENMENT,				FALSE,	NULL,		0,		EFINFO_NONE,	"completely lights up and magically maps the level")
EFFECT(LIGHT_AREA,					FALSE,	NULL,		2,		EFINFO_NONE,	"lights up the surrounding area, causing %s damage to light-sensitive creatures within %d grids")
EFFECT(DARKEN_AREA,					FALSE,	NULL,		0,		EFINFO_NONE,	"darkens the surrounding area")
EFFECT(BALL,						TRUE,	"dam",		3,		EFINFO_NONE,	"fires a %s ball of radius %d, dealing %s damage at the centre")
EFFECT(BREATH,						TRUE,	NULL,		3,		EFINFO_NONE,	"fires a %s ball of radius %s, dealing %s damage at the centre")
EFFECT(SWARM,						TRUE,	"dam",		3,		EFINFO_NONE,	"fires a series of %s balls of radius %s, dealing %s damage at the centre of each")
EFFECT(STAR,						FALSE,	"dam",		2,		EFINFO_NONE,	"fires a %s line in all directions, dealing %s damage")
EFFECT(STAR_BALL,					FALSE,	"dam",		3,		EFINFO_NONE,	"fires %s balls of radius %d in all directions, dealing %s damage at the centre of each")
EFFECT(BOLT,						TRUE,	"dam",		2,		EFINFO_NONE,	"casts a %s bolt dealing %s damage")
EFFECT(BEAM,						TRUE,	"dam",		2,		EFINFO_NONE,	"casts a %s beam dealing %s damage")
EFFECT(BOLT_OR_BEAM,				TRUE,	"dam",		2,		EFINFO_NONE,	"casts a %s bolt or beam dealing %s damage")
EFFECT(LINE,						TRUE,	"dam",		2,		EFINFO_NONE,	"creates a %s line dealing %s damage")
...
EFFECT(TOUCH,						FALSE,	NULL,		1,		EFINFO_NONE,	"%s on all adjacent squares")
EFFECT(TOUCH_AWARE,					FALSE,	NULL,		1,		EFINFO_NONE,	"%s on all adjacent squares")
