...
EFFECT(PROJECT_LOS,					FALSE,	"dam",		2,		EFINFO_SEEN,	"damages all %s in line of sight by %s hitpoints")
...
EFFECT(BREATH,						TRUE,	NULL,		3,		EFINFO_BALL,	"fires a %s ball of radius %d, dealing %s damage at the centre")
