...
MON_TMD(STUN,   false,  true,     RF_NO_STUN,  50,       MON_MSG_DAZED,          MON_MSG_NOT_DAZED,      MON_MSG_MORE_DAZED     )
MON_TMD(CONF,   false,  true,     RF_NO_CONF,  50,       MON_MSG_CONFUSED,       MON_MSG_NOT_CONFUSED,   MON_MSG_MORE_CONFUSED  )
MON_TMD(FEAR,   true,   true,     RF_NO_FEAR,  10000,    MON_MSG_FLEE_IN_TERROR, MON_MSG_NOT_AFRAID,     MON_MSG_MORE_AFRAID    )
MON_TMD(SLOW,   false,  true,     RF_NO_SLOW,  50,       MON_MSG_SLOWED,         MON_MSG_NOT_SLOWED,     MON_MSG_MORE_SLOWED    )
MON_TMD(FAST,   false,  true,     0,           50,       MON_MSG_HASTED,         MON_MSG_NOT_HASTED,     MON_MSG_MORE_HASTED    )
MON_TMD(HOLD,   false,  false,    RF_NO_SLEEP, 50,       MON_MSG_HELD,           MON_MSG_NOT_HELD,       0                      )
