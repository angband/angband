...
MON_TMD(STUN,   true,   true,     RF_NO_STUN,  50,       MON_MSG_DAZED,          MON_MSG_NOT_DAZED,      MON_MSG_MORE_DAZED     )
MON_TMD(CONF,   true,   true,     RF_NO_CONF,  50,       MON_MSG_CONFUSED,       MON_MSG_NOT_CONFUSED,   MON_MSG_MORE_CONFUSED  )
