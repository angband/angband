...
SLAY(ACID2,		OF_BRAND_FIZZ,  FLAG_END,  RF_IM_ACID,	3,	"slightly corrodes","slightly corrode", "fizzes",   		"creatures not resistant to acid", 			"weak acid")
SLAY(ELEC2,		OF_BRAND_BUZZ,  FLAG_END,  RF_IM_ELEC,	3,	"weakly zaps",     	"weakly zap",     	"buzzes",			"creatures not resistant to electricity", 	"weak lightning")
SLAY(FIRE2,		OF_BRAND_WARM,  FLAG_END,  RF_IM_FIRE,	3,	"slightly burns",   "slightly burn",    "grows warm", 		"creatures not resistant to fire", 			"weak flames")
SLAY(COLD2,		OF_BRAND_COOL,  FLAG_END,  RF_IM_COLD,	3,	"chills" , 			"chill",  			"grows cool", 		"creatures not resistant to cold", 			"weak frost")
SLAY(POISON2,	OF_BRAND_ICKY,  FLAG_END,  RF_IM_POIS,	3,	"slightly poisons", "slightly poison",  "glows green",  	"creatures not resistant to poison", 		"weak venom")
