...
- **Installing Angband:** Get the [Latest release](https://github.com/angband/angband/releases/tag/4.2.2) or [compile it yourself](https://angband.readthedocs.io/en/latest/hacking/compiling.html).
