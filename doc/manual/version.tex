\section{Version Information --- version.txt}
...
the Official Angband Home Page ("http://rephial.org") for the most
...
\paragraph{}The Official Angband Home Page ("http://rephial.org/") serves not only as 
the most up to date description of Angband, but also lists changes made 
between versions, and changes planned for upcoming versions, and lists 
...
Robert Alan Koeneke\index{Robert Alan Koeneke}               Jimmey
Wayne Todd Jr.\index{Jimmey Todd}
